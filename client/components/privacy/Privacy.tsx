...
const Privacy: React.FC<Props> = () => {
  return (
    <Container>
      <Contents>
        <h4>
          디엔케이드림(&apos;https://paysys.kr&apos; 이하 행사전표시스템)은(는)
          [개인정보보호법] 제30조에 따라 정보주체의 개인정보를 보호하고 이와
          관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과
          같이 개인정보 처리방침을 수립·공개합니다.
        </h4>
        <h5>○ 이 개인정보처리방침은 2018년 1월 1일부터 적용됩니다.</h5>
        ...
        <ul>
          <li>
            ...
            <ul>
              <li>
                &lt;디엔케이드림&gt;(행사전표시스템)은(는) 다음의 목적을 위하여
          ...
          <li>
            ...
            <ul>
              <li>
                &lt;디엔케이드림&gt;은(는) 법령에 따른 개인정보 보유·이용기간
          ...
          <li>
            ...
            <ul>
              ...
              <li>
                ...
                등을 통하여 하실 수 있으며 디엔케이드림은(는) 이에 대해 지체
                없이 조치하겠습니다.
              </li>
              <li>
              ...
              <li>
                6. 디엔케이드림은(는) 정보주체 권리에 따른 열람의 요구,
          ...
          <li>
            ...
            <ul>
              <li>
                1. &lt;디엔케이드림&gt;은(는) 다음의 개인정보 항목을 처리하고
                있습니다.
                <ul>
                  <li>① 행사전표시스템 회원 관리</li>
          ...
          <li>
            ...
            <ul>
              <li>
                1. &lt;디엔케이드림&gt;은(는) 개인정보 보유기간의 경과, 처리목적
              ...
              <li>
                ...
                <ul>
                  <li>
                    ① &lt;디엔케이드림&gt;은(는) 파기 사유가 발생한 개인정보를
                    선정하고, &lt;디엔케이드림&gt; 의 개인정보 보호책임자의
                    승인을 받아 개인정보를 파기합니다.
                  </li>
                  <li>
          ...
          <li>
            ...
            <ul>
              <li>
                1. 디엔케이드림 은(는) 이용자에게 개별적인 맞춤서비스를 제공하기
          ...
          <li>
            ...
            <ul>
              <li>
                1. 디엔케이드림 은(는) 개인정보 처리에 관한 업무를 총괄해서
              ...
              <li>
                2. 정보주체께서는 디엔케이드림 의 서비스(또는 사업)을
                이용하시면서 발생한 모든 개인정보 보호 관련 문의, 불만처리,
                피해구제 등에 관한 사항을 개인정보 보호책임자 및 담당부서로
                문의하실 수 있습니다. 디엔케이드림 은(는) 정보주체의 문의에 대해
          ...
          <li>
            ...
            <ul>
              <li>
                ...
                청구를 상기 책임자에게 할 수 있습니다.
                &lt;디엔케이드림&gt;은(는) 정보주체의 개인정보 열람청구가
                신속하게 처리되도록 노력하겠습니다.
              </li>
            </ul>
          </li>
          ...
          <li>
            ...
            <ul>
              <li>이 개인정보처리방침은 2022년 1월 1부터 적용됩니다.</li>
            </ul>
          </li>
        </ul>
      </Contents>
